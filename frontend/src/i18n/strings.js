...
export const strings = {
  bn: {
    ...
    ai_title: 'AI পরামর্শ',
    ai_subtitle: 'ফসল, দাম বা রোগ সম্পর্কে জিজ্ঞাসা করুন',
    ai_welcome_title: 'আজ আমি কীভাবে সাহায্য করতে পারি?',
    ai_welcome_hint: 'একটি প্রশ্ন লিখুন অথবা নিচের একটি বেছে নিন',
    ai_input_placeholder: 'আপনার প্রশ্ন লিখুন...',
    ai_disclaimer: 'AI-জেনারেটেড পরামর্শ — কাজ করার আগে যাচাই করুন।',
    ai_image_too_big: 'ছবিটি অনেক বড়। অনুগ্রহ করে ছোট ফাইল বেছে নিন।',
    ai_attach: 'ছবি যুক্ত করুন',
    ai_help_button: 'AI সাহায্য',
    ...
    fd_hello: 'স্বাগতম',
    fd_sub: 'আপনার ফসল ও তালিকা এখানে দেখুন।',
    fd_farmer: 'কৃষক',
    fd_stat_total: 'মোট ফসল',
    fd_stat_available: 'উপলব্ধ',
    fd_stat_value: 'সম্ভাব্য আয়',
    fd_my_crops: 'আমার ফসল',
    fd_add_crop: 'নতুন ফসল',
    fd_add_first: 'প্রথম ফসল যোগ করুন',
    fd_loading: 'লোড হচ্ছে...',
    fd_error: 'সমস্যা হয়েছে।',
    fd_no_crops: 'এখনও কোনো ফসল যোগ করা হয়নি।',
    fd_col_name: 'ফসল',
    fd_col_qty: 'পরিমাণ',
    fd_col_price: 'দাম',
    fd_col_status: 'অবস্থা',
    fd_view: 'দেখুন',
    ad_title: 'অ্যাডমিন প্যানেল',
    ad_sub: 'স্বাগতম',
    ad_stat_users: 'মোট ইউজার',
    ad_stat_crops: 'মোট ফসল',
    ad_stat_active: 'সক্রিয় তালিকা',
    ad_stat_today: 'আজ নতুন',
    ad_tab_users: 'ইউজার',
    ad_tab_crops: 'ফসল',
    ad_search_users: 'নাম বা ফোন দিয়ে খুঁজুন...',
    ad_all_roles: 'সব ধরনের',
    ad_col_name: 'নাম',
    ad_col_phone: 'ফোন',
    ad_col_roles: 'ভূমিকা',
    ad_col_status: 'অবস্থা',
    ad_col_farmer: 'কৃষক',
    bd_hello: 'হ্যালো',
    bd_sub: 'তাজা ফসল কিনুন সরাসরি কৃষকের কাছ থেকে।',
    bd_browse_title: 'মার্কেটপ্লেস',
    bd_browse_sub: 'উপলব্ধ ফসল দেখুন ও অর্ডার করুন।',
    bd_prices_title: 'লাইভ দাম',
    bd_prices_sub: 'বাজারদর ও দামের গতি দেখুন।',

    cf_title: 'নতুন ফসল তালিকাভুক্ত করুন',
    cf_sub: 'আপনার ফসলের বিস্তারিত তথ্য দিন। ছবি যোগ করলে বিক্রি দ্রুত হয়।',
    cf_crop_name: 'ফসলের নাম',
    cf_crop_name_ph: 'যেমন: টমেটো, বেগুন, আলু',
    cf_variety: 'জাত (ঐচ্ছিক)',
    cf_variety_ph: 'যেমন: ব্রি ধান-২৮',
    cf_category: 'শ্রেণী',
    cf_category_ph: 'একটি শ্রেণী নির্বাচন করুন',
    cf_quantity: 'পরিমাণ',
    cf_unit: 'একক',
    cf_unit_kg: 'কেজি',
    cf_unit_ton: 'টন',
    cf_unit_mon: 'মন',
    cf_unit_piece: 'পিস',
    cf_per_kg: 'প্রতি কেজি',
    cf_per_ton: 'প্রতি টন',
    cf_per_mon: 'প্রতি মন',
    cf_per_piece: 'প্রতি পিস',
    cf_price: 'মূল্য',
    cf_price_hint: 'একক প্রতি দাম দিন',
    cf_description: 'বিবরণ (ঐচ্ছিক)',
    cf_description_ph: 'ফসলের মান, উৎস বা অন্য কোনো তথ্য...',
    cf_organic: 'জৈবিক ফসল',
    cf_images: 'ছবি (সর্বাধিক ৪টি)',
    cf_images_hint: 'JPG, PNG বা WEBP • প্রতিটি ২MB পর্যন্ত',
    cf_submit: 'তালিকাভুক্ত করুন',
    cf_submitting: 'পাঠানো হচ্ছে...',
    cf_cancel: 'বাতিল',
    cf_success: 'সফলভাবে তালিকাভুক্ত হয়েছে!',
    cf_error: 'কিছু ভুল হয়েছে',

    rg_title: 'অ্যাকাউন্ট তৈরি করুন',
    rg_sub: 'AgroMart-এ যোগ দিন — কৃষক বা ক্রেতা হিসেবে।',
    rg_name: 'পূর্ণ নাম',
    rg_name_ph: 'আপনার নাম লিখুন',
    rg_phone: 'ফোন নম্বর',
    rg_email: 'ইমেইল (ঐচ্ছিক)',
    rg_email_ph: 'you@example.com',
    rg_password: 'পাসওয়ার্ড',
    rg_password_ph: 'কমপক্ষে ৮ অক্ষর',
    rg_role: 'আমি একজন',
    rg_submit: 'অ্যাকাউন্ট তৈরি করুন',
    rg_submitting: 'তৈরি হচ্ছে...',
  ...
  en: {
    ...
    ai_title: 'AI advisor',
    ai_subtitle: 'Ask about crops, prices, or diseases',
    ai_welcome_title: 'How can I help you today?',
    ai_welcome_hint: 'Ask a question or pick one below',
    ai_input_placeholder: 'Type your question...',
    ai_disclaimer: 'AI-generated advice — always verify before acting.',
    ai_image_too_big: 'Image is too large. Please choose a smaller file.',
    ai_attach: 'Attach an image',
    ...
    fd_hello: 'Welcome',
    fd_sub: 'Manage your crop listings and see your activity.',
    fd_farmer: 'Farmer',
    fd_stat_total: 'Total crops',
    fd_stat_available: 'Available',
    fd_stat_value: 'Potential value',
    fd_my_crops: 'My crops',
    fd_add_crop: 'Add crop',
    fd_add_first: 'Add your first crop',
    fd_loading: 'Loading...',
    fd_error: 'Something went wrong.',
    fd_no_crops: 'No crops listed yet.',
    fd_col_name: 'Crop',
    fd_col_qty: 'Quantity',
    fd_col_price: 'Price',
    ...
    ad_stat_crops: 'Total crops',
    ad_stat_active: 'Active listings',
    ad_stat_today: 'New today',
    ad_tab_users: 'Users',
    ad_tab_crops: 'Crops',
    ad_search_users: 'Search by name or phone...',
    ad_all_roles: 'All roles',
    ad_col_name: 'Name',
    ad_col_phone: 'Phone',
    ad_col_roles: 'Roles',
    ad_col_status: 'Status',
    ad_col_farmer: 'Farmer',
    bd_hello: 'Hello',
    bd_sub: 'Buy fresh produce direct from farmers.',
    bd_browse_title: 'Marketplace',
    bd_browse_sub: 'See available crops and place orders.',
    bd_prices_title: 'Live prices',
    bd_prices_sub: 'Real-time market prices and trends.',

    cf_title: 'List a new crop',
    cf_sub: 'Enter your crop details. Adding photos helps you sell faster.',
    cf_crop_name: 'Crop name',
    cf_crop_name_ph: 'e.g. Tomato, Eggplant, Potato',
    cf_variety: 'Variety (optional)',
    cf_variety_ph: 'e.g. BRRI Dhan-28',
    cf_category: 'Category',
    cf_category_ph: 'Select a category',
    ...
    cf_per_ton: 'per ton',
    cf_per_mon: 'per mon',
    cf_per_piece: 'per piece',
    cf_price: 'Price',
    cf_price_hint: 'Price per unit',
    cf_description: 'Description (optional)',
    cf_description_ph: 'Quality, origin, or any other details...',
    cf_organic: 'Organic crop',
    cf_images: 'Photos (up to 4)',
    cf_images_hint: 'JPG, PNG or WEBP • Up to 2MB each',
    cf_submit: 'List crop',
    cf_submitting: 'Submitting...',
    cf_cancel: 'Cancel',
    cf_success: 'Crop listed successfully!',
    cf_error: 'Something went wrong',

    rg_title: 'Create your account',
    rg_sub: 'Join AgroMart as a farmer or buyer.',
    rg_name: 'Full name',
    rg_name_ph: 'Enter your name',
    rg_phone: 'Phone number',
    rg_email: 'Email (optional)',
    rg_email_ph: 'you@example.com',
    rg_password: 'Password',
    rg_password_ph: 'At least 8 characters',
    rg_role: 'I am a',
    rg_submit: 'Create account',
    rg_submitting: 'Creating...',
