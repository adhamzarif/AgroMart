// SecurePayments.jsx — deep-dive page for the "Secure payments" feature.
import { Link } from 'react-router-dom';
import { useLang } from '../../context/LangContext.jsx';

const HERO_IMG = 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1600';

export default function SecurePayments() {
  const { t } = useLang();

  const benefits = [
    { icon: '🔒', title: 'sp_benefit1_title', desc: 'sp_benefit1_desc' },
    { icon: '📱', title: 'sp_benefit2_title', desc: 'sp_benefit2_desc' },
    { icon: '🧾', title: 'sp_benefit3_title', desc: 'sp_benefit3_desc' },
    { icon: '↩️', title: 'sp_benefit4_title', desc: 'sp_benefit4_desc' },
  ];

  const steps = [
    { n: 1, title: 'sp_step1_title', desc: 'sp_step1_desc' },
    { n: 2, title: 'sp_step2_title', desc: 'sp_step2_desc' },
    { n: 3, title: 'sp_step3_title', desc: 'sp_step3_desc' },
    { n: 4, title: 'sp_step4_title', desc: 'sp_step4_desc' },
  ];
    ...
    <div className="bg-white">
      ...
      <section className="bg-m1 py-14 text-center text-white">
        <div className="mx-auto max-w-2xl px-6">
          <h2 className="mb-3 text-2xl font-bold font-display">{t('sp_cta_title')}</h2>
          <p className="mb-6 text-white/85">{t('sp_cta_sub')}</p>
